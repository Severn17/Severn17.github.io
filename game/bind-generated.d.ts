...
declare namespace game{
    ...
    class NewConfiguration extends ut.Component {
        constructor();
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: NewConfiguration): NewConfiguration;
        static _toPtr(p: number, v: NewConfiguration): void;
        static _tempHeapPtr(v: NewConfiguration): number;
        static _dtorFn(v: NewConfiguration): void;
    }
