...
Object.defineProperties(entities.game.Pipes.Component, { cid: { configurable: true, get: function() { delete entities.game.Pipes.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.Pipes.Component.cid = Module._ut_component_register_cid(/*entities.game.Pipes.Component*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"entities::game::Pipes::Component"*/, 0, 0); } } });
...
Object.defineProperties(game.Ground, { cid: { configurable: true, get: function() { delete game.Ground.cid; var offsetsPtr = 0, offsetsCount = 0; return game.Ground.cid = Module._ut_component_register_cid(/*game.Ground*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"game::Ground"*/, 0, 0); } } });
...
game.NewConfiguration = function() {
};
game.NewConfiguration.prototype = Object.create(null);
game.NewConfiguration.prototype.constructor = game.NewConfiguration;
Object.defineProperties(game.NewConfiguration.prototype, {
});
game.NewConfiguration._size = 1;
game.NewConfiguration._fromPtr = function(ptr, v) {
  v = v || Object.create(game.NewConfiguration.prototype);
  return v;
};
game.NewConfiguration._toPtr = function(ptr, v) {
};
game.NewConfiguration._toTempHeapPtr = function(ptr, v) {
};
game.NewConfiguration._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) game.NewConfiguration._toTempHeapPtr(ptr, v);
  return ptr;
};
game.NewConfiguration.StorageView = function(ptr) {
  this._ptr = ptr;
};
game.NewConfiguration.StorageView.prototype = Object.create(null);
game.NewConfiguration.StorageView.prototype.constructor = game.NewConfiguration.StorageView;
game.NewConfiguration._view = game.NewConfiguration.StorageView;
game.NewConfiguration.StorageView._isSharedComp = game.NewConfiguration._isSharedComp = false;
game.NewConfiguration.StorageView._fromPtr = game.NewConfiguration._fromPtr;
game.NewConfiguration.StorageView._toPtr = game.NewConfiguration._toPtr;
game.NewConfiguration.StorageView._tempHeapPtr = game.NewConfiguration._tempHeapPtr;
game.NewConfiguration.StorageView._size = game.NewConfiguration._size;
game.NewConfiguration.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(game.NewConfiguration.StorageView.prototype, {
});
game.NewConfiguration._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// game.NewConfiguration is a POD type, so a JavaScript side copy constructor game.NewConfiguration._copyFn = function copy(src, dst) { ... } does not need to be generated for it
Object.defineProperties(game.NewConfiguration, { cid: { configurable: true, get: function() { delete game.NewConfiguration.cid; var offsetsPtr = 0, offsetsCount = 0; return game.NewConfiguration.cid = Module._ut_component_register_cid(/*game.NewConfiguration*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"game::NewConfiguration"*/, 0, 0); } } });
Object.defineProperties(game.NewConfiguration.StorageView, { cid: { configurable: true, get: function() { return game.NewConfiguration.cid; } } });
